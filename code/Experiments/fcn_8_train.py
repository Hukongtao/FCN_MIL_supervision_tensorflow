...
log_folder = 'logs/fcn8s'

fcn_16s_checkpoint_path = 'checkpoints/model_fcn16s_final/model_fcn16s_final.ckpt'

save_path = 'checkpoints/model_fcn8s_final/model_fcn8s_final.ckpt'
...
# Define the loss function (cross_entropy_sum) for image level supervision
...
# The operation for initializing the variables.
local_vars_init_op = tf.local_variables_initializer()

combined_op = tf.group(local_vars_init_op, global_vars_init_op)

# save only model variables and omit optimization-related and other variables.
